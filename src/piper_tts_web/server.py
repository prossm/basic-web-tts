...
def find_piper_executable():
    ...
    possible_paths = [
        ...
        os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "piper", "build", "piper"),  # Local build
    ]
...
async def synthesize_speech(request: SynthesisRequest):
    ...
    try:
        ...
        cmd = [
            ...
            "--espeak-data", "/opt/homebrew/Cellar/espeak-ng/1.52.0/share/espeak-ng-data"
        ]
